...
def cardReport(allHand, playHand):
    string = ""
        ...
        for j in allHand:
            if i == 2:
                ...
                if j[1] == "Hearts":
                    ...
                    string += Fore.YELLOW + j[0]
                elif j[1] == "Clubs":
                    string += Fore.GREEN + j[0]
                elif j[1] == "Spades":
                    string += Fore.BLUE + j[0]
                elif j[1] == "Stars":
                    string += Fore.RED + Back.YELLOW + j[0]
                elif j[1] == "Moons":
                    string += Fore.BLACK + j[0]
                elif j[1] == "Moles":
                    string += Fore.MAGENTA + j[0]
                elif j[1] == "Arenels":
                    string += Fore.MAGENTA + Back.BLACK + j[0]

                if j[0] == "10" or j[0] == "11" or j[0] == "12":
                    string += Fore.WHITE + Back.WHITE + "  "
                else:
                    string += Fore.WHITE + Back.WHITE + "   "
                string += Back.BLACK + " "        
