...
def report(chipsToWin, totChips):
    ...
    print("  █    ",Fore.LIGHTRED_EX + "Ante: ", Fore.WHITE + str(ANTE), Fore.LIGHTBLUE_EX + "   Round: ", Fore.WHITE + str(ROUND), 
          Fore.GREEN + "                 █\n  █    ", Fore.YELLOW + "Chips to win: ", Fore.WHITE + str(int(chipsToWin)), 
          Fore.GREEN + "                    █\n  █    ", Fore.CYAN + "Current Chips: ", Fore.WHITE + str(totChips), 
          Fore.GREEN + "                     █\n  █    ", Fore.RED + "Hands: ", Fore.WHITE + str(HANDS[1]), Fore.BLUE + "   Discards: ", 
          Fore.WHITE + str(DISCARDS[1]), Fore.GREEN + "             █\n  █                                            █\n  ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀", "\n\n")
